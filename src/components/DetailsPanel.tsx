  ...
  return (
    <aside className="details-panel">
      <div className="inspector-head">
        ...
        <button className={asset.is_favorite ? "icon-action active" : "icon-action"} onClick={() => onToggleFavorite(asset)} aria-label={asset.is_favorite ? "取消收藏" : "收藏"} title={asset.is_favorite ? "取消收藏" : "收藏"}>
